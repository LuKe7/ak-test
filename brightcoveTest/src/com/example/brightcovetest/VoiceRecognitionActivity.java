...
public class VoiceRecognitionActivity extends Activity {
    ...
    public static void launchInstance(Activity activity, int requestCode) {
        Intent intent = new Intent(activity, VoiceRecognitionActivity.class);
        ...
        if (requestCode == VOICE_RECOGNITION_REQUEST_CODE)
            ...
            if(resultCode == RESULT_OK) {
                ...
                if (!textMatchList.isEmpty()) {
                    ...
                    } else if (textMatchList.get(0).contains("mute")){
                        VolumeManager.getInstance().setStreamMute(AudioManager.STREAM_MUSIC, true);
